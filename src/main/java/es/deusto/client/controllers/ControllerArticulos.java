...
public class ControllerArticulos {
	...
	public boolean insertarPelicula(String nombre, double precio, String sinopsis, String genero, String fecha_estr, double puntuacion, String caratula, double descuento) {
		boolean correcto;
		try {
			logger.info("###ControllerArticulos: ServiceLocator.getService().insertarPelicula###");
			...
			logger.info("###ControllerAlquiler: Se ha insertado la película correctamente###");
	...
	public boolean insertarVideojuego(String nombre, double precio, String descripcion, String categoria, String fecha_lanz, double puntuacion, String caratula, double descuento) {
		boolean correcto;
		try {
			logger.info("###ControllerArticulos: ServiceLocator.getService().insertarVideojuego###");
			...
			logger.info("###ControllerAlquiler: Se ha insertado el videojuego correctamente###");
			
			return correcto;
		}catch(Exception e) {
			logger.error("$ Error al insertar videojuego " + e.getMessage());
	...
	public boolean updateDescuento(String nombreArticulo, double descuento) {
		try {
			logger.info("###ControllerArticulos: ServiceLocator.getService().updateDescuento###");
			...
			logger.error("$ Error al actualizar descuento " + e.getMessage());
	...
	public boolean updatePrecio(String nombreArticulo, double precio) {
		try {
			logger.info("###ControllerArticulos: ServiceLocator.getService().updatePrecio###");
			...
			logger.error("$ Error al actualizar precio " + e.getMessage());
