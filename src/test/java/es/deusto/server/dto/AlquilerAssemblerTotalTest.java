...
public class AlquilerAssemblerTotalTest {
    ...
    public void testAssembleWithMultipleAlquileres() {
        // Prepare test data
        Pelicula pelicula1 = new Pelicula("Articulo-Pelicula", 10.0, "Some sinopsis", "Some genre", "2022-01-01", 8.0,
                "Some caratula", 0.0);
        Alquiler alquilerPelicula1 = new Alquiler(pelicula1, 10.0, "2022-01-01", "2022-01-02", true,
                "Articulo-Pelicula");

        Videojuego videojuego = new Videojuego("Articulo-Videojuego", 15.0, "Some sinopsis", "Some genre", "2022-01-01",
                8.0,
                "Some caratula", 0.0);
